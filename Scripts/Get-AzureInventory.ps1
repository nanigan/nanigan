...
.DESCRIPTION
    The script exports your Azure inventory as a CSV file. It builconnds different CSV files for each subscription with resources. 
.EXAMPLE
...
param (
    # (optional) Specifies the subscription.
    [Parameter()]
    [string]$SubscriptionId = "805b1035-89ad-44e4-9f1d-d27d67305a2b"
)
